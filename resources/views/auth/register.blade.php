...
<!-- Mirrored from preview.keenthemes.com/metronic8/demo3/authentication/layouts/overlay/sign-up.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 08 Jan 2023 16:57:07 GMT -->
				...
				<div class="d-flex flex-column-fluid flex-lg-row-auto justify-content-center justify-content-lg-end p-12">
					...
					<div class="bg-body d-flex flex-center rounded-4 w-md-600px p-10">
						...
						<div class="w-md-400px">
							<!--begin::Form-->
							<form class="form w-100" novalidate="novalidate" action="{{ route('register')}}">
								<!--begin::Heading-->
